...
With these steps acting as a guide, let's build an example program that will
...
Now that we've stored to the variable, we can read from it, using GEP again. We
