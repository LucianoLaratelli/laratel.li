...
(def twitter
  [:a {:href "https://twitter.com/lucianolaratell", :target "_blank", :rel "noopener", :title "Twitter"}
   [:svg {:stroke "currentColor", :fill "none", :stroke-linejoin "round", :width "24", :viewbox "0 0 24 24", :xmlns "http://www.w3.org/2000/svg", :stroke-linecap "round", :stroke-width "2", :height "24"}
...
(def keybase
  [:a {:href "https://keybase.io/lucianolaratelli", :target "_blank", :rel "noopener", :title "Keybase"}
   [:svg {:stroke "none", :fill "currentColor", :stroke-linejoin "round", :width "24", :viewbox "0 0 24 24", :xmlns "http://www.w3.org/2000/svg", :stroke-linecap "round", :stroke-width "2", :height "24"}
...
(def social-media-row
  [:> drac/Box
   ...
   (map #(vector :span
                 ...
                 %)
        [twitter email keybase github linkedin])])
